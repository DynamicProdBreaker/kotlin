    ...
    private val SyntheticLocalType.wasmType
        get() = when (this) {
            SyntheticLocalType.IS_INTERFACE_PARAMETER ->
                WasmRefNullType(wasmFileCodegenContext.referenceHeapType(backendContext.irBuiltIns.anyClass).value)
            SyntheticLocalType.IS_INTERFACE_ANY_ARRAY ->
                WasmRefNullType(Synthetics.HeapTypes.wasmAnyArrayType.value)
