...
class WasmIrParametersForCompile(
    ...
    val debuggerParameters: DebuggerCompileParameters,
    val multimoduleParameters: MultimoduleCompileParameters?,
)
...
fun compileWasmIr(parameters: WasmIrParametersForCompile): WasmCompilerResult {
    ...
    val multimoduleParameters = parameters.multimoduleParameters
    ...
    val linkedModule = wasmCompiledModuleFragment.linkWasmCompiledFragments(
        multimoduleParameters = multimoduleParameters,
        exceptionTagType = exceptionTagType
    )

    val debuggerParameters = parameters.debuggerParameters
    ...
    val sourceMapGeneratorForText = runIf(parameters.generateWat && debuggerParameters.generateSourceMaps) {
