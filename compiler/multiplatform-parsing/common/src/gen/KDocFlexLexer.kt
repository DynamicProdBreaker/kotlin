...
private class Bitset(
  ...
  private var bitset = LongArray(initialSize)

  internal operator fun set(i: Int, b: Boolean) {
    ensureCapacity(i)
    val index = i shr INDEX_SHIFT
    bitset[index] = if (b) {
      bitset[index] or (1L shl i)
    } else {
      bitset[index] and (1L shl i).inv()
    }
  }

  internal operator fun get(i: Int): Boolean {
    val index = i shr INDEX_SHIFT
  ...
  companion object {
    private const val INDEX_SHIFT = 6
  }
}
  ...
  private fun zzUnpackcmap_blocks(): IntArray {
    val result: IntArray = IntArray(30464)
    var offset: Int = 0
  ...
  private fun zzUnpackAction(): IntArray {
    val result: IntArray = IntArray(87)
    var offset: Int = 0
  ...
  private fun zzUnpacktrans(): IntArray {
    val result: IntArray = IntArray(1020)
    var offset: Int = 0
