...
fun main(args: Array<String>) {
    val argParser = ArgParser("convertReport", prefixStyle = ArgParser.OptionPrefixStyle.GNU)

    val kotlinxReport by argParser.argument(ArgType.String, description = "Report from kotlinx.benchmark")
    ...
    jmh.decodeFromString<List<Benchmark>>(File(kotlinxReport).readText()).flatMap {
