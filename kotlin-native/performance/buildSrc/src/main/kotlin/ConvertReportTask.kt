 ...
 */
open class ConvertReportTask @Inject constructor(
        private val execOperations: ExecOperations,
        objectFactory: ObjectFactory,
) : DefaultTask() {
    /**
     * Classpath of the `convertReport` tool
     */
    @get:Classpath
    val convertReportClasspath: ConfigurableFileCollection = objectFactory.fileCollection()
    ...
    /**
     * Additional arguments for the `convertReport` tool
     */
    @get:Input
    ...
    fun run() {
        execOperations.javaexec {
            classpath = convertReportClasspath
            mainClass.set("ConvertReportCLI")
